...
```{r Distributions of Entrepreneurship Measures, echo=FALSE, cache=TRUE}
grid.arrange(
...
```{r Sole Proprietorship, echo=FALSE, cache=TRUE}
...
```{r Highly Active Venture Density, echo=FALSE, cache=TRUE}
...
```{r 50 Establishment, echo=FALSE, cache=TRUE}
...
```{r Nonfarm Nonemployer, echo=FALSE, cache=TRUE}
## Nonemployer Establishment Map ##
map %>% addTiles() %>% setView(lng = -100.000, lat = 31.000, zoom = 6) %>% 
  addPolygons(stroke = F, smoothFactor = 0.2, fillOpacity = 0.9,
...
```{r Nonfarm Proprietor, echo=FALSE, cache=TRUE}
## Nonemployer Establishment Map ##
map %>% addTiles() %>% setView(lng = -100.000, lat = 31.000, zoom = 6) %>% 
  addPolygons(stroke = F, smoothFactor = 0.2, fillOpacity = 0.9,
...
```{r Number of Firms, echo=FALSE, cache=TRUE}
## Nonemployer Establishment Map ##
map %>% addTiles() %>% setView(lng = -100.000, lat = 31.000, zoom = 6) %>% 
  addPolygons(stroke = F, smoothFactor = 0.2, fillOpacity = 0.9,
