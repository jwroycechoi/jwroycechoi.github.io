...
```{r Microsoft Import, echo=FALSE, results='hide', cache=TRUE}
## Import the Dataset
...
```{r IRR Rural Index Import and Clean, results='hide', cache=TRUE}
## Import the Dataset
...
```{r Census Dataset Retrieval, cache=TRUE}
...
```{r Census Dataset Mod1, results='hide', cache=TRUE}
...
```{r ABS Data Retrieve, cache=TRUE}
...
```{r Retrieve ACS broadband subscription data, cache=TRUE}
...
```{r FCC Data in the background, echo=FALSE, results='hide', cache=TRUE}
library(RSocrata)
